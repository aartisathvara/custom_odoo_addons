...
with open('/home/odoo/workspace/custom-addons/data_migration/odoorpc_script/sale_order.csv', newline='') as csv_file:
...
with open('/home/odoo/workspace/custom-addons/data_migration/odoorpc_script/sale_order_line.csv',newline='') as csv_file:
        csv_file = csv.DictReader(csv_file)
        excel_row_line = 2
        for row in csv_file:
            rec = dict(row)
